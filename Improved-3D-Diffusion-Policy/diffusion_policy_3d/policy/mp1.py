...
from diffusion_policy_3d.model.diffusion.conditional_unet1d_mp1 import ConditionalUnet1D
...
class MP1(BasePolicy):
    def __init__(self, 
            ...
            point_downsample=False,# parameters passed to step
            **kwargs):
        super().__init__()
